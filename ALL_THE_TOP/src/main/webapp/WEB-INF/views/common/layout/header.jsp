...
<html>
<head>
<script src="${contextPath}/resources/bootstrap/js/header.js"
	type="module"></script>
<script>
	function getMember() {
	...
	<div id="__next">
		<header class="wrap_padding css-vfh4pc e10hkk351">
			...
			<aside class="css-13co1xy e10hkk350">
				<button type="button" class="css-xyumn e10hkk356" id="searchButton"
					style="background-image:url(${contextPath}/resources/bootstrap/img/icon_search.svg);">검색</button>
				<div class="menu_my">
					<div class="profile_img css-8nwm4w e10hkk353">
						<picture class="loaded css-ovhph3 euf32k20"> <c:choose>
							<c:when test='${sessionScope.memberId != null}'>
								<img class="loaded css-1doy9ip euf32k22" src="">
							</c:when>
							<c:otherwise>
								<a href="${contextPath}/login"><img
									class="loaded css-1doy9ip euf32k22"
									src="${contextPath}/resources/bootstrap/img/alltt_logo_white_background_100.png"></a>
							</c:otherwise>
						</c:choose> </picture>
					</div>
				</div>
					...
					<div class="menu_my_content wrap_margin">
						<div class="profile">
							<div class="profile_img css-vvktly e10hkk353">
								<picture class="loaded css-ovhph3 euf32k20"> <img
									class="loaded css-1doy9ip euf32k22" src=""> </picture>
							</div>
